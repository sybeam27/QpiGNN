...
def train_model(train_data, in_dim, device, optimal_lambda, tau=0.9, lam=0.01, hidden_dim=64, epochs=500):
...
if __name__ == "__main__":
    ...
    df.to_csv("generalization/generalization_all_runs.csv", index=False)
